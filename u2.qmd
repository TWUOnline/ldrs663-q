...
- **Read** [**Facilitating Learning and Change in Groups**](https://infed.org/mobi/facilitating-learning-and-change-in-groups-and-group-sessions/)  [**ARCHIVE**](https://web.archive.org/web/20250514185822/https://infed.org/mobi/facilitating-learning-and-change-in-groups-and-group-sessions)
- **Read** [**What is a Group?**](https://infed.org/mobi/what-is-a-group/)  [**ARCHIVE**](https://web.archive.org/web/20250514173100/https://infed.org/mobi/what-is-a-group)
...
<!-- //todo #23 Add an introduction to this activity? -->
...
<!-- // todo #24 Perhaps adding an example to each of the five characteristics of learning groups would be a good idea! -->
...
<!-- // todo #25 I’m wondering whether we should reconsider this question, as the students have not yet been introduced to coaching concepts in this unit. -->
...
::: {.learning-activity}
<!-- // todo #26 Should we include an introduction that encourages the student to start thinking about the planning of their facilitation session? Or should we include specific questions that prompt the student to begin planning their facilitation session? -->

Read the following article [_Facilitating Learning and Change in Groups and Group Sessions_](https://infed.org/mobi/facilitating-learning-and-change-in-groups-and-group-sessions/) (_Infed.Org_, n.d.). [**ARCHIVE**](https://web.archive.org/web/20250514185822/https://infed.org/mobi/facilitating-learning-and-change-in-groups-and-group-sessions)
...
Take a moment to read the following article [_What is a Group?_](https://infed.org/mobi/what-is-a-group/) (_Infed.Org_, n.d.).  [**ARCHIVE**](https://web.archive.org/web/20250514173100/https://infed.org/mobi/what-is-a-group)
...
<!-- // todo #27 The ‘Checking Your Learning’ section needs to be developed. It only has the Unit Learning Outcomes right now. -->
