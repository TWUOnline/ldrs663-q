...
A key component of facilitation and coaching in an educational environment is understanding how educators come to know what learners know. In this case, coaches and facilitators are educators in that they are key to supporting learners as they study. A facilitator or coachcan play the role of the more experienced 'other' that a learner needs to get them from the zone of not being able to complete a task, to being able to complete it with assistance in their zone of proximal development [@vygotskyMindSociety1978].
