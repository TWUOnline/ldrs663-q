...
## Topic 1 - What is Educational Experience {.unnumbered}


Earlier we were introduced to the idea that a learning environment can be understood as overlapping presences: *cognitive presence, social presence,* and *teaching presence.* In this unit, we explore what is experienced within this environment by examining the theoretical ground the CoI model is built upon.
...
**// todo #39** Use a different format to highlight the following text, since this is not a learning activity 

::: {.learning-activity}
#### Continuity of experience, in Dewey’s (1938) words, 

> *“means that every experience both takes up something from those which have gone before and modifies in some way the quality of those which come after”*(p. 35).
...
**// todo #40** Use a different format to highlight the following text, since this is not a learning activity
...
The first Learning Activity for Unit 4 will focus on the work of John Dewey in his writing *Experience and Education.* While the link below will take you to the entire text (*which you are more then welcome to read!*), the focus for this section will be on Chapter 2 titled: ***The Need of a Theory of Experience.***

**// todo #41** Set up the following link to open in a new tab
...
**// todo #42** It seems that the instructions for the learning activity are missing. Exactly what readings do students have to complete?
...
### What is study? {.unnumbered} 

The term comes into English as a shortening of the Old French noun *estudie,* and its verb form *estudier,* both based on the Latin term *studium.* This is also the root of the Latin word student. Cicero provides us with a formative use of the term in De Inventione:
...
::: {.learning-activity title="Estimayed Time: 00 minutes"}

**// todo #43** It seems that the content provided is sufficient for students to reflect on the questions listed. I’m just wondering if this was the intended design, or if we’re missing some reading resources for this activity.
...
## Topic 4: Institutionalization of Teaching and Learning {.unnumbered}
...
### The Course of Study {.unnumbered}
...
## Topic 5: Emerging Models of Open and Multi-Access Education {.unnumbered}
...
[Teaching in a Digital Age](https://pressbooks.bccampus.ca/teachinginadigitalagev3m/part/chapter-1-fundamental-change-in-education/)
...
## Topic 6 - Multi-Access Learning Environments {.unnumbered}
...
::: {.learning-activity}
#### Look, Read, and Reflect {.unnumbered}
...
✔️  Meet in Zoom <span class='badge-blue'>Wednesday, October 25 - 10:30 AM PDT</span> [Check your local time here](https://www.timeanddate.com/worldclock/fixedtime.html?msg=LDRS663+Meeting&iso=20231025T1030&p1=1109&ah=1)  
✔️  **Read and Reflect** on the commentary in Unit 5.  
✔️  **Publish** your [Showcase Post](https://ma-lead.github.io/ldrs663/assessments.html#showcase-post) using the category `ldrs663` and `showcase`.   
✔️  Complete the [Facilitation Resource Project](https://ma-lead.github.io/ldrs663/assessments.html#facilitation-resource-project). 
✔️  Please complete these items by <span class='badge-blue'>Wednesday, November 8 - by sundown</span>, or let me know if you will need a bit more time.  

:::
-->

<!--
👥  Meet in Zoom [Friday, May 6 - 7:30 AM PDT](https://www.timeanddate.com/worldclock/fixedtime.html?msg=LDRS663+Class+Meeting&iso=20220506T0730&p1=1109&ah=1&am=30)      
📖 **Read** and **Reflect** [**Experience and Education: Chapter 2**](http://ruby.fgcu.edu/courses/ndemers/colloquium/experienceducationdewey.pdf).   
📖 **Read** and **Reflect** Topic 2 Learning Activity  
📖 **Read** and **Reflect** Topic 3 Learning Activity  
📖 **Read** and **Reflect** [**Teaching in a Digital Age (Ch. 1)**](https://pressbooks.bccampus.ca/teachinginadigitalagev2/part/chapter-1-fundamental-change-in-education/)   
📷 **Look,** **Read,** and **Reflect** [**Realigning Higher Education for the 21st-Century Learner through Multi-Access Learning**](https://jolt.merlot.org/vol9no2/irvine_0613.htm)  
📖 **Read** and **Reflect** [**Teaching in a Digital Age (Ch. 10)**](https://pressbooks.bccampus.ca/teachinginadigitalagev2/part/chapter-10-modes-of-delivery/)  
⌨️ **Publish** your [Unit 5 Post](https://far.twu.ca/ldrs/663202109/assignments) using the category `ldrs663`.  
👥 **Complete** your [Peer Coaching Session](https://far.twu.ca/ldrs/663202109/assignments) by [Friday, May 6 - 7:30 AM PDT](https://www.timeanddate.com/worldclock/fixedtime.html?msg=LDRS663+Class+Meeting&iso=20220506T0730&p1=1109&ah=1&am=30)   
✅  Please complete these items by [Friday, May 6 - 7:30 AM PDT](https://www.timeanddate.com/worldclock/fixedtime.html?msg=LDRS663+Class+Meeting&iso=20220506T0730&p1=1109&ah=1&am=30)

✅ It is also critical to begin working on your major project for the course, the [Facilitation Resource Project](https://ma-lead.github.io/ldrs663/assessments.html#facilitation-resource-project-40). We will talk about this in class on April 29.   
