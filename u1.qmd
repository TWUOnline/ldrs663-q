...
<!-- -  Meet in Zoom [<span class='badge-blue'>Monday, November 20, 1-3pm </span>(Click to check your local time)](https://www.timeanddate.com/worldclock/fixedtime.html?msg=LDRS+663&iso=20231120T13&p1=1109&ah=2)  -  -->
- **Before you start: Follow** the instructions on the '[Getting Started with Obsidian](https://ma-lead.github.io/ldrs663/getting-started-with-obsidian.html)' page in the course notes in Moodle.
- **Read** [Critical inquiry in a text-based environment: Computer conferencing in higher education](https://www-sciencedirect-com.twu.idm.oclc.org/science/article/pii/S1096751600000166)  
- **Read** [Getting the mix right again: An updated and theoretical rationale for interaction](http://www.irrodl.org/index.php/irrodl/article/view/149/230)   
- **Read** [Interaction and the online distance classroom: Do instructional methods effect the quality of interaction?](https://rdcu.be/cKSGf)   
- **Write** your arguments for or against the *Interaction Equivalency Theorem* in the Learning community.  
-  [UPDATE] **Draft** your autoethnography proposal according to the instructions in the 'Assessment Tasks' section in Moodle.
  - To get started thinking about autoethnography, please refer to this article available in the TWU Library. Chang, H. (2021). *Individual and Collaborative Autoethnography for Social Science Research*. In T. E. Adams, S. H. Jones, & C. Ellis (Eds.), Handbook of Autoethnography (2nd ed., pp. 53–65). Routledge. DOI: 10.4324/9780429431760-6

- Please complete these tasks by ~~Sunday, Jul 28~~ **Sunday, Aug 3** before your regular bedtime. 


## Overview {.unnumbered}

Welcome to Unit 1 of LDRS 463/663! In this unit, we will begin by considering the nature of learning communities through the lens of a model called the _Community of Inquiry (CoI)_ ([Garrison et al., 2000](https://www.sciencedirect.com/science/article/pii/S1096751600000166?){target="_blank"}; [Vaughan et al., 2013](http://www.aupress.ca/index.php/books/120229){target="_blank"}). The CoI model proposes that there are three overlapping components, or presences, to any learning environment; cognitive presence (constructing meaning), social presence (projecting a sense of yourself), and teaching presence (designing and facilitating the learning experience). The CoI model is grounded in a long history of social constructivism which is the idea that learning is fundamentally a social process ([Dewey, 1897](https://en.wikisource.org/wiki/My_Pedagogic_Creed){target="_blank"}; [Vygotsky, 1978](https://twu.idm.oclc.org/login?url=http://search.ebscohost.com/login.aspx?direct=true&db=cat05965a&AN=alc.191437&site=eds-live){target="_blank"}). We will also consider various modes of interaction in learning environments and how these two models have informed the model of teaching and learning in TWU online courses.
...
1. *[Introductions and Learning Stories* topic in the Learning Community.](https://twu.discourse.group/t/introductions-and-learning-stories)
2. [Exploring the Community of Inquiry:](#activity-exploring-the-community-of-inquiry) Read *Critical Inquiry in a Text-Based Environment: Computer Conferencing in Higher Education*.
3. [What Is Interaction?:](#activity-what-is-interaction) Watch *You Keep Using That Word* and consider what interaction is.
4. [Theoretical Rationale for Interaction:](#activity-theoretical-rationale-for-interaction) Read *Getting the Mix Right Again: An Updated and Theoretical Rationale for Interaction*.
...
- Garrison, D. R., Anderson, T., & Archer, W. (1999). [_Critical Inquiry in a Text-Based Environment: Computer Conferencing in Higher Education_](https://doi.org/10.1016/S1096-7516(00)00016-6){target="_blank"}. The Internet and Higher Education, 2(2), 87–105.
- Anderson, T. (2023, October). [_Getting the Mix Right Again: An Updated and Theoretical Rationale for Interaction_](http://www.irrodl.org/index.php/irrodl/article/view/149/230){target="_blank"}| The International Review of Research in Open and Distributed Learning.
- Kanuka, H. (2011). [_Interaction and the Online Distance Classroom: Do Instructional Methods Effect the Quality of Interaction?_](https://rdcu.be/cKSGf){target="_blank"} 23(2–3).

#### Optional Resource {.unnumbered}

- Vaughan, N., Cleveland-Innes, M., & Garrison, D. (2013). [_Teaching in blended learning environments: Creating and sustaining communities of inquiry._](http://www.aupress.ca/index.php/books/120229) Athabasca: AU Press. (This book is available for free at AUPress.)



## Introduction to the Community of Inquiry Model {#sec-learning-stories}

Before you dive into the content of this unit in LDRS 463/663, take a moment to recall some particularly memorable learning experiences that you have had. They don't have to be particularly profound in terms of *what* you learned, but profound because of the fact that you still remember *that* you learned something and *how* you learned it. Pick one or two of those experiences and share them in the *[Introductions and Learning Stories* topic in the Learning Community.](https://twu.discourse.group/t/introductions-and-learning-stories) Make sure to tell us about the context of your experience. Who was there? What did you do to learn? Why do you remember it? 

### Social Constructivism

There is a very good chance that your recollection of a memorable learning experience as part of the previous learning activity included a description of some sort of social interaction. This isn't always the case, but the idea that learning is a social process has a long history in education. Many theorists credit John Dewey for bringing this idea to the forefront of educators' minds. In his 1897 treatise *My Pedagogic Creed* he writes:
...
Following Dewey, many others, such as Jean Piaget, Jerome Bruner, and Lev Vygotsky have written about what has now become known as the educational theory of *social constructivism*, or, more concisely, constructivism [@driscollPsychologyLearningInstruction2005]. Driscoll describes constructivism as a theory that
...
![Figure 1.1 Community of Inquiry Model (Garrison, et al., (2000)](assets/u2/CoI-Model.png){.lightbox fig-alt="Community of Inquiry Model" width=400}
...
### Activity: Exploring the Community of Inquiry {.unnumbered}

::: {.learning-activity title="Read, Annotate, and Reflect "}

**Read** [*Critical inquiry in a text-based environment: Computer conferencing in higher education*](https://www-sciencedirect-com.twu.idm.oclc.org/science/article/pii/S1096751600000166){target="_blank"} (access through the TWU library).

If you haven't done so previously, sign up for and activate [hypothes.is](https://hypothes.is/signup){target="_blank"} and while you are reading the article, leave some annotations that connect what you are reading to your own experience.

Use the tag 'ldrs463-663' in any annotations you create so that we can all find each other.

[Click here for assistance getting set up with hypothes.is.](https://servicehub.twu.ca/TDClient/1904/Portal/KB/ArticleDet?ID=146716){target="_blank"}
...
### Activity: What Is Interaction? {.unnumbered}

::: {.learning-activity title="Watch and Reflect"}

[Watch: *You keep using that word.*](https://youtu.be/gpGjexZcJdg){target="_blank"}

{{< video https://www.youtube-nocookie.com/embed/G2y8Sx4B2Sk?si=ZuZoOVhJU0xcsS6U >}}
...
<iframe src="https://create.twu.ca/h5p/wp-admin/admin-ajax.php?action=h5p_embed&id=2" width="576" height="240" frameborder="0" allowfullscreen="allowfullscreen" title="Interaction Quiz"></iframe><script src="https://create.twu.ca/h5p/wp-content/plugins/h5p/h5p-php-library/js/h5p-resizer.js" charset="UTF-8"></script>
...
![Figure 1.2 Anderson's Modes of Interaction (2003)](assets/u2/Modes-Interaction-Anderson_new.png "Modes of Interaction from Terry Anderson"){.lightbox fig-alt="Modes of Interaction from Terry Anderson" width="400"}
...
![Figure 1.3 Kanuka's Model of Interaction (2011)](assets/u2/Kanuka-Modes-of-Interaction_new.png "Kanuka's Model of Interaction"){.lightbox fig-alt="Kanuka's Model of Interaction" width="280"}
...
![Figure 1.4 Madland's Model of Interaction (2014)](assets/u2/Modes-of-Interaction-Madland_new.png "Madland's model of interaction"){.lightbox fig-alt="Madland's model of interaction" width="400"}
...
### Activity: Theoretical Rationale for Interaction {.unnumbered}

::: {.learning-activity title="Read and Reflect"}

Read the following article by Terry Anderson, [_Getting the mix right again: An updated and theoretical rationale for interaction_](http://www.irrodl.org/index.php/irrodl/article/view/149/230){target="_blank"}. As you read, consider what interactions you have experiences in online or f2f courses.
...
<!-- ## Unit 1 Assessment{.unnumbered}


::: {.learning-activity}
###  Post 1

Please complete the assignment under 'Post 1' on the 'Assessment' page in the menu.
