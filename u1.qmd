...
- **Before you start: Follow** the instructions on the '[Getting Started with Obsidian](https://twuonline.github.io/ldrs663-q/obsidian.html)' page in the course notes in Moodle.
...
-  **Draft** your autoethnography proposal according to the instructions in the 'Assessment Tasks' section in Moodle.
